...
public class MainListView extends MyListRecord {
    ...
    public MainListView(Context context, HeaderModel data) {
        ...
        setId(mData.getInventoryShipmentId());
    }

    @Override
    public void setId(long id) {
        super.setId(id);
        mData.setInventoryShipmentId(id);
    }
    ...
    protected TableLayout firstRowFirstCol() {
        ...
        TextView tvShipmentCode = new TextView(mContext);
        tvShipmentCode.setText(mData.getShipmentCode());
        tvShipmentCode.setTypeface(null, Typeface.BOLD);
        tvShipmentCode.setSingleLine();
        trLine1.addView(tvShipmentCode);

        TextView tvShipmentDate = new TextView(mContext);
        tvShipmentDate.setText(DateTimeUtil.ToDateDisplayString(mData.getShipmentDate()));
        tvShipmentDate.setSingleLine();
        trLine1.addView(tvShipmentDate);
    ...
    protected TextView firstRowSecondCol() {
        ...
        tvSelf.setText(String.valueOf(mData.getQuantityBox()) + "\n" + String.valueOf(mData.getQuantity()));
