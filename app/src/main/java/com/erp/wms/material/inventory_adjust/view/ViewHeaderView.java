...
public class ViewHeaderView extends ScrollView {
    ...
    public ViewHeaderView(Context context) {
        ...
        scrollViewContainer.setOrientation(LinearLayout.VERTICAL);
            ...
            mTvType = new TextView(mContext);
            mTvType.setLayoutParams(new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT));
            scrollViewContainer.addView(mTvType);
    ...
    public void setData(HeaderModel data) {
        ...
        mTvNo.setText(mData.getAdjustCode());
        mTvDate.setText(DateTimeUtil.ToDateDisplayString(mData.getAdjustDate()));
		mTvType.setText(mData.getAdjustType());
