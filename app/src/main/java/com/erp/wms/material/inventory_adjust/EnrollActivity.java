...
import com.erp.wms.material.inventory_adjust.view.EnrollView;
...
public class EnrollActivity extends SherlockActivity {
    ...
    protected void save() {
        hideKeyboard();
        MaterialInventoryAdjustAPI.InsertDetail(mInventoryAdjustId, mView.getData(), new RestfulResponse(this) {
            @Override
