...
public class ViewDetailView extends MyListRecord {
    ...
    protected LinearLayout firstRowFirstCol() {
        ...
        tvPalletCartonNo.setText(mData.getPallet());
        tlSelf.addView(tvPalletCartonNo);

        // -- Third Line
        TextView tvPackedGroup = new TextView(mContext);
        tvPackedGroup.setText(mData.getPackedGroup() != null && !mData.getPackedGroup().isEmpty() ? mData.getPackedGroup() : "No Packed Group");
        tlSelf.addView(tvPackedGroup);
